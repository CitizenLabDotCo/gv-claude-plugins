...
(function () {
  ...
  function fill(root) {
    ...
    // No re-stamp needed: GV.hash normalises avatar faces out of the provenance hash
    // (faces are runtime presentation, like the theme colours), so filling them never
    // changes a host's linked state.
  }
